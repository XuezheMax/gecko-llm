...
from gecko_extension.ops import ema_parameters_fwd, ema_parameters_bwd
...
class EMAParametersFunc(torch.autograd.Function):
    ...
    def forward(
        ...
        log_q = q.log()
        weight, bias, vander = ema_parameters_fwd(p, log_q, gamma, hx, length)
    ...
    def backward(
        ...
        p_grad, q_grad, gamma_grad, hx_grad = ema_parameters_bwd(weight_grad, bias_grad, p, log_q, gamma, hx, vander)
