...
from gecko_extension.ops import ema_hidden_fwd, ema_hidden_bwd
...
class EMAHiddenFunc(torch.autograd.Function):
    ...
    def forward(
        ...
        log_q = q.log()
        h, v = ema_hidden_fwd(x, p, log_q, hx)
    ...
    def backward(
        ...
        x_grad, p_grad, q_grad, hx_grad = ema_hidden_bwd(h_grad, x, p, log_q, hx, v)
