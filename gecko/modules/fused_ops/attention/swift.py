...
class FusedAttentionFunc(torch.autograd.Function):
    ...
    def forward(
        ...
        y, w = _fused_efficient_attention_fwd(
    ...
    def backward(
        ...
        q_grad, k_grad, v_grad = _fused_efficient_attention_bwd(
            y_grad, q, k, v, w, scale, use_causal_mask
        )
...
def swift_efficient_attention_bwd(
    ...
    return _fused_efficient_attention_bwd(
        grad, q, k, v, w, scale, use_causal_mask
    )
